  ...
  return (
    <div className="booking">
      <div className="booking__top d-flex align-items-center justify-content-between">
        <h3>
          ${price} <span>/bir kishi uchun</span>
        </h3>
...
<<<<<<< HEAD
                <input type="number" placeholder="Soni" min={0} id="guestSize" required onChange={handleChange} />  
=======
...
>>>>>>> 47ef2c127d988aab2c913d7e26d7d1912ddbc95b
            </FormGroup>
        </Form>
      </div>
      ...
      <div className="booking__bottom">
        <ListGroup>
          <ListGroupItem className="border-0 px-0">
            <h5 className="d-flex align-items-center gap-1">${price} <i className="ri-close-line"></i> bir kishi uchun</h5>
            <span> ${price}</span>
          </ListGroupItem>
          <ListGroupItem className="border-0 px-0">
            <h5>Xizmat haqi</h5>
        ...
        <Button className="btn primary__btn w-100 mt-4" onClick={handleClick}>Band qilish</Button>
      </div>
    </div>
  );
};
